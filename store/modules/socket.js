...
const useSocketStore = defineStore('socket', {
  unistorage: {
    key: "socket", // 缓存的键，默认为该 store 的 id，这里是 user,
    paths: ['chatMessage', 'chatList', 'sessionList', 'newChat', 'noticeIdArr', 'newNotice', 'globalErrorMsg',
  ...
  actions: {
    ...
    setNoticeList(data) {
      ...
      var unReadeGongGao = gonggaoNoticeList.filter((v) => !this.promptNoticeReadList.some((item) => item == v
        .noticeId))
